import React, { useState, useEffect, handleClose } from 'react';
...
<div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
    ...
    <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
        {usersState?.data.map((product) => (
        <Link to={"/details/"+product.id}>
            <img class="hover:grow hover:shadow-lg" src={"http://localhost:8000/"+product.image} style={{width:400, height:400}} />
